      ...
      <div class="about__container container grid">
        <div class="about__data">
          ...
          <p class="aboutt about__description text-body1">
            ...
            Kaduna Agricultural Development Project (KADP) to a Statutory
            Agency; the Kaduna Agricultural Development Agency (KADA); Kaduna
            State Livestock Development Roadmap and Law establishing Kaduna
            Livestock and Livestock Products Regulatory Agency; Agricultural
            Sector Implementation Plan (SIP) of the Kaduna State Development
            Plan (SDP); Commercial, Industrial and Tourism Sector Implementation
            Plan (SIP) of the Kaduna State Development Plan; Kaduna State
            Charter on Ease of Doing Business; Kaduna State Job Creation and
            Skill Development Policy; Extension Service Delivery Framework for
            Nomadic Dairy Farmers that Increased Daily Milk Output from 1litre
            to 3.5 litres per Cow; Community Business Model for Nomads in the
            Kachia Grazing Reserve with a Processing Facility that has Cut Down
            Milk Wastages.
          </p>
